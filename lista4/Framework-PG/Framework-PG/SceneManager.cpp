...
void SceneManager::setupScene()
{
	...
	obj->setDimension(glm::vec3(800.0f,800.0f, 1.0f));
	...
	obj->setDimension(glm::vec3(300.0f, 200.0f, 1.0f));
	obj->setShader(shader);
	objects.push_back(obj); 

	//CERCA
	obj = new Sprite;
	obj->setPosition(glm::vec3(0.0f, 100.0f, 0.0));
	...
	obj->setDimension(glm::vec3(150.0f, 300.0f, 1.0f));
	obj->setShader(shader);
	objects.push_back(obj);
	...
	texID = loadTexture("../textures/house2.png");
	objects[1]->setTexture(texID);
	texID = loadTexture("../textures/fence.png");
	...
	texID = loadTexture("../textures/arvore.png");
